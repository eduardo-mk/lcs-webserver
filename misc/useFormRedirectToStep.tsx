 ...
 *
 */
function useFormRedirectToStep(): (url: string) => void {
  ...
  return (next_page: string) => {
    // if (noChecks) {
    //   console.log(
    //     `useFormRedirectToStep : no checks : current path : ${pathname} : next page : ${next_page}`
    //   );
    //   push(next_page);
    // }

    console.log(
      `useFormRedirectToStep : current path : ${pathname} : next page : ${next_page}`
    );
    switch (next_page) {
...
export default useFormRedirectToStep;
